...
public class GlobalUtil {
    ...
    public static boolean isValidEmail(String emailId) {
        return ObjectUtil.isNonEmptyStr(emailId) && Patterns.EMAIL_ADDRESS.matcher(emailId).matches();
    }
    ...
    /**
     * This is used to check the given password is 1 number,1 special char,1 uppercase.
     *
     * @param passwordPattern which patter you want
